...
def create_interactive_pie_chart(df, cat_dict, state_name):
    ...
    chart = create_pie_chart(df, st.session_state[state_name])
    ...
    if selected_points:
        ...
        if selected_category == st.session_state[state_name]:
            st.session_state[state_name] = None
        else:
            st.session_state[state_name] = selected_category
...
create_interactive_pie_chart(df, cat_dict, "selected_state")
if st.session_state["selected_state"]:
        st.write(f'You clicked on: {st.session_state["selected_state"]}')